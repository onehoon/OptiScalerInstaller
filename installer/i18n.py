...
_STRINGS_BY_LANG: dict[Lang, AppStrings] = {
    "ko": AppStrings(
        ...
        main=MainUiStrings(
            ...
            window_title_template="OptiScaler 설치기 v{version}",
            app_title="OptiScaler 설치기",
            ...
            select_game_hint="게임을 선택하면 정보를 볼 수 있습니다.",
        ...
        dialogs=DialogStrings(
            ...
            game_db_error_body="Google 시트에 연결하지 못했습니다.\n네트워크 상태 또는 시트 접근 권한을 확인해 주세요.",
            installing_title="설치 진행 중",
            installing_body="설치가 이미 진행 중입니다. 잠시만 기다려 주세요.",
            select_game_card_body="설치할 게임 카드를 선택해 주세요.",
